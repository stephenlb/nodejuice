...
"");if(!d)return i(1);switch(b.type){case "json":d=w(d);break;case "script":d=eval(d)}y.call(a,d);window[c]="";i(0)}};m("error",a,function(){i(1)});f.unique=c;a.src=b.url+v(f,b.url);setTimeout(function(){s.appendChild(a)},1)},h=g(),j=+"{{speed}}",k=0,q=0;if("{{scroll}}"==="yes"){m("touchstart",document,o);m("scroll",window,o)}window["-nodeJuice-"]||(window["-nodeJuice-"]=1)&&l(+"{{wait}}")})("http://{{host}}/");
